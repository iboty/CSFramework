...
using CSFramework.Privileges.Model;

namespace CSFramework.Privileges.Helper
{
    public static  class DataHelper
    {
        ...
        public static PrivilegeModel GetPrivilegeModel(Control control, PrivilegeModel parentModel = null)
        {
            ...
            var desc = control as IPrivileges;
        ...
        public static PrivilegeModel PrivilegeDescToModel(IPrivileges desc, PrivilegeModel parentModel)
        {
